...
class Veta_Curso extends Basic
{
    ...
    public function save($notify=false){
		...
		error_log( "FETCH  " . print_r($this->fetched_row['display_name_c'], true) );
		
		if($this->display_name_c == ''){
			$this->display_name_c = "" . $this->subclass_c . " " . $this->tipovisa;
		} else {
			$this->display_name_c = "" . $this->subclass_c . " " . $this->tipovisa;
		}
