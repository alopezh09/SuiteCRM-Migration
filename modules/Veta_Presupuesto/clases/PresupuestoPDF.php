...
class PresupuestoPDF extends FPDF
{
    ...
    public function generate_pdf( Veta_Presupuesto $p ) {
		...
		$file_name = 'QUOTE-' . $this->string_replace_pdf_name($this->requeriment->veta_requerimiento_leads_name) . '-' . $this->p->name . '.pdf';
        $this->Output( $sugar_config[ 'upload_dir' ] . 'quotes/' . $file_name , 'F' );
		//$this->Output( 'QUOTE-' . $this->string_replace_pdf_name($this->requeriment->veta_requerimiento_leads_name) . '-' . $this->p->name . '.pdf' );
    ...
    public function header() {
        ...
        if ($r->sponsored_australian_citizen_c) {
            $this->MultiCell( 0 , 3 , utf8_decode( strtoupper( $r->australian_sponsor_name_c ) ) , 0 , 'R' );
            $this->MultiCell( 0 , 3 , utf8_decode( " ") , 0 , 'R' ); 
            $this->SetFont( 'Arial' , 'B' , 9 );
            $this->MultiCell( 0 , 3 , utf8_decode( 'SPONSOR TO: ' . strtoupper( $r->veta_requerimiento_leads_name ) ) , 0 , 'R' );     
        } else {
            $this->SetFont( 'Arial' , 'B' , 10 );
            $this->SetTextColor( 45 , 45 , 45 );
            $this->SetLineWidth( 0.2 ); 
            $this->Ln( 5 );
            $this->Cell( 0 , 3 , utf8_decode( $this->string_replace(strtoupper( substr( $r->veta_requerimiento_leads_name , 0 , 40 ) ) ) ) , 0 , 0 , 'R' );
            $this->lead_name = $r->veta_requerimiento_leads_name;
			$this->Ln( 4 );
			$this->SetFont( 'Arial' , 'B' , 9 );
			$this->MultiCell( 0 , 3 , utf8_decode( 'SPONSORED BY: ' . $this->string_replace(strtoupper( $r->company_name ) ) ) , 0 , 'R' );   
    ...
    private function print_legals($array_name, $array_description){
        ...
        foreach( $array_description as $legales_cursos_name ) {              
            ...
            $this->SetFont( 'Arial' , '' , 9 );             
            $this->MultiCell( 0 , 4 , utf8_decode( $legales_cursos_name ) , 0 , 'J' );
            // $this->MultiCell( 0 , 3 , utf8_decode( " ") , 0 , 'R' );
            // $this->MultiCell( 0 , 3 , utf8_decode( " ") , 0 , 'R' );
     ...
     */
     ...
     private function replaceText($char,$str)
     {
    ...
    private function print_servicios( Veta_Presupuesto $p ) {
        ...
        //if( ( ! empty( $p->examen_medico ) and $p->examen_medico > 0 ) or ( ! empty( $p->seguro ) and $p->seguro > 0 ) or ( ! empty( $p->total_visa ) and $p->total_visa > 0 ) ) {
            ...
            $this->descuento = ( $this->p->descuento * 1 );
            ...
            //if( ! empty( $p->total_visa ) and $p->total_visa > 0 ) {
                ...
                $department_visa_fee_1 -> retrieve($p->veta_tiposvisa_id2_c);
                $department_visa_fee_2 = new Veta_TiposVisa();
                $department_visa_fee_2 -> retrieve($p->veta_tiposvisa_id3_c);
                $department_visa_fee_3 = new Veta_TiposVisa();
                $department_visa_fee_3 -> retrieve($p->veta_tiposvisa_id4_c);
                $department_visa_fee_4 = new Veta_TiposVisa();
                $department_visa_fee_4 -> retrieve($p->veta_tiposvisa_id5_c);
                $department_visa_fee_5 = new Veta_TiposVisa();
                $department_visa_fee_5 -> retrieve($p->veta_tiposvisa_id6_c); 
				$department_visa_fee_6 = new Veta_TiposVisa();
                $department_visa_fee_6 -> retrieve($p->veta_tiposvisa_id11_c); 
				$department_visa_fee_7 = new Veta_TiposVisa();
                $department_visa_fee_7 -> retrieve($p->veta_tiposvisa_id12_c); 


                $p->total_visa = 0;                

                if ($department_visa_fee_1->total_visa > 0)  {
                    $this->print_billing_info ("" .$department_visa_fee_1->name. "", $department_visa_fee_1->total_visa, '+','',8);
                    $p->total_visa += $department_visa_fee_1->total_visa;
                }
                if ($department_visa_fee_2->total_visa > 0)  {
                    $this->print_billing_info ("" .$department_visa_fee_2->name. "", $department_visa_fee_2->total_visa, '+','',8);
                    $p->total_visa += $department_visa_fee_2->total_visa;
                }
                if ($department_visa_fee_3->total_visa > 0)  {
                    $this->print_billing_info ("" .$department_visa_fee_3->name. "", $department_visa_fee_3->total_visa, '+','',8);
                    $p->total_visa += $department_visa_fee_3->total_visa;
                }
                if ($department_visa_fee_4->total_visa > 0)  {
                    $this->print_billing_info ("" .$department_visa_fee_4->name. ")", $department_visa_fee_4->total_visa, '+','',8);
                    $p->total_visa += $department_visa_fee_4->total_visa;
                }
                if ($department_visa_fee_5->total_visa > 0)  {
                    $this->print_billing_info ("" .$department_visa_fee_5->name. "", $department_visa_fee_5->total_visa, '+','',8);
                    $p->total_visa += $department_visa_fee_5->total_visa;
                }
				if ($department_visa_fee_6->total_visa > 0)  {
                    $this->print_billing_info ("" .$department_visa_fee_6->name. "", $department_visa_fee_6->total_visa, '+','',8);
                    $p->total_visa += $department_visa_fee_6->total_visa;
                }
				if ($department_visa_fee_7->total_visa > 0)  {
                    $this->print_billing_info ("" .$department_visa_fee_7->name. "", $department_visa_fee_7->total_visa, '+','',8);
                    $p->total_visa += $department_visa_fee_7->total_visa;
                }				
                ...
                // $this->print_billing_info ("tipo fee ( " . $department_visa_fee_1->type_of_department_fee_c . " )", $department_visa_fee_1->total_visa, '+','',8);
    ...
    private function print_details() {
        ...
        $r->aplicant_mmm_fee = $this->total_visabuclass_fees;
