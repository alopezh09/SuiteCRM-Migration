...
class NVC_Companies extends Company
{
    public $new_schema = true;
    public $module_dir = 'NVC_Companies';
    public $object_name = 'NVC_Companies';
    public $table_name = 'nvc_companies';
