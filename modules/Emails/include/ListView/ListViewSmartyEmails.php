...
class ListViewSmartyEmails extends ListViewSmarty
{
    ...
    public function setup(
        ...
        $offset =  $_REQUEST['Emails2_EMAIL_offset'] ? $_REQUEST['Emails2_EMAIL_offset'] : $offset;
        $params['orderBy'] = $_REQUEST['Emails2_EMAIL_ORDER_BY'] ? $_REQUEST['Emails2_EMAIL_ORDER_BY'] : 'date_sent_received';
        $params['sortOrder'] = $_REQUEST['Emails2_EMAIL_ORDER_BY'] ? $_REQUEST['lvso'] : 'DESC';
