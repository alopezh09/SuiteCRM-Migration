...
class NVC_Company extends Company
{
    public $new_schema = true;
    public $module_dir = 'NVC_Company';
    public $object_name = 'NVC_Company';
    public $table_name = 'nvc_company';
    ...
    public $company_contact_person_name;
    public $company_contact_position;
    public $company_leap_id;
    public $number_of_position_available;
