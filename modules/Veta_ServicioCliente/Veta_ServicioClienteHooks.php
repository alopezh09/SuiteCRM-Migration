...
class Veta_ServicioClienteHooks
{
    ...
    public function create_note_pre($bean)
    {
        ...
        $debug_export = var_export($bean->virtual_note, true);
        LoggerManager::getLogger()->error('[CHR] '. $debug_export);
    ...
    public function create_note_post($bean)
    {
        ...
        if (!empty($bean->note)) {
            ...
            JOIN veta_requerimiento_contacts_c ON veta_requerimiento_contacts_c.veta_requerimiento_contactscontacts_ida = contacts.id AND veta_requerimiento_contacts_c.deleted = 0 
            JOIN veta_requerimiento ON veta_requerimiento.id = veta_requerimiento_contacts_c.veta_requerimiento_contactsveta_requerimiento_idb 
            JOIN veta_requerimiento_veta_recibo_c ON veta_requerimiento_veta_recibo_c.veta_requerimiento_veta_reciboveta_requerimiento_ida = veta_requerimiento.id AND veta_requerimiento_veta_recibo_c.deleted = 0                  
            JOIN veta_recibo ON veta_recibo.id = veta_requerimiento_veta_recibo_c.veta_requerimiento_veta_reciboveta_recibo_idb AND veta_recibo.deleted = 0 
            JOIN veta_recibo_opportunities_c ON veta_recibo_opportunities_c.veta_recibo_opportunitiesveta_recibo_ida
            JOIN opportunities ON opportunities.id = veta_recibo_opportunities_c.veta_recibo_opportunitiesopportunities_idb AND opportunities.deleted = 0 
            JOIN veta_serviciocliente_opportunities_c ON veta_serviciocliente_opportunities_c.veta_serviciocliente_opportunitiesopportunities_ida  = opportunities.id AND veta_serviciocliente_opportunities_c.deleted = 0 
            JOIN veta_serviciocliente ON veta_serviciocliente.id = veta_serviciocliente_opportunities_c.veta_serviciocliente_opportunitiesveta_serviciocliente_idb
            WHERE veta_serviciocliente.id =  '" . $bean->id . "' AND contacts.deleted = 0";
            ...
            $bean->note->parent_type = 'Veta_ServicioCliente';
