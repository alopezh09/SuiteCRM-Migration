...
class SugarWidgetFieldDateTime extends SugarWidgetReportField
{
    ...
    public function queryFilterTP_not_null(&$layout_def)
    {
        global $timedate;
        if (isset($layout_def['rel_field'])) {
            $field_name = $this->reporter->db->convert(
        ...
        return "$field_name IS NOT NULL AND $field_name <> '' AND $field_name <> '0000-00-00'";
    }
    ...
    public function displayInput($layout_def)
    {
        ...
        $filterTypes = array(' '                 => $app_strings['LBL_NONE'],
                             ...
                             'TP_not_null'      => $home_mod_strings['LBL_NOT_NULL'],
