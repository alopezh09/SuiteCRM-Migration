...
$dictionary["nvc_companies_leads_1"] = array (
  ...
  array (
    ...
    4 => 
    array (
      'name' => 'nvc_companies_leads_1leads_idb',
      'type' => 'varchar',
      'len' => 36,
    ),
  ),
  ...
  array (
    ...
    1 => 
    array (
      'name' => 'nvc_companies_leads_1_ida1',
      'type' => 'index',
      'fields' => 
      array (
        0 => 'nvc_companies_leads_1nvc_companies_ida',
      ),
    ),
    2 => 
    array (
      'name' => 'nvc_companies_leads_1_alt',
      'type' => 'alternate_key',
      'fields' => 
      array (
        0 => 'nvc_companies_leads_1leads_idb',
      ),
    ),
  ),
);