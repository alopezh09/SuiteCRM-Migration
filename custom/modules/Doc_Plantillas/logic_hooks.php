...
$hook_array['after_relationship_add'][] = Array(2, 'Add documents Description', 'custom/modules/Doc_Plantillas/addDocument.php','addDocumentoSolicitadoClass', 'addDocumentoSolicitado_Requeriments');
// $hook_array['after_relationship_add'][] = Array(4, 'Add documents Description', 'custom/modules/Doc_Plantillas/addDocument.php','addDocumentoSolicitadoClass', 'relatePlantillas');
...
$hook_array['after_relationship_delete'][] = Array(3, 'Delete documents Description', 'custom/modules/Doc_Plantillas/delDocument.php','delDocumentoSolicitadoClass', 'delDocumentoSolicitado_Requeriments');
