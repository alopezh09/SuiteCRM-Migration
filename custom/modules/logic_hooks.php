...
$hook_array['after_save'][] = Array(1240, 'Update Portal Col', 'custom/modules/globalHooks.php','GlobalHooks', 'updateCacheWhatsapp'); 

$hook_array['after_relationship_delete'][] = Array(1243, 'Update Portal Col', 'custom/modules/globalHooks.php','GlobalHooks', 'updateCacheWhatsapp');
