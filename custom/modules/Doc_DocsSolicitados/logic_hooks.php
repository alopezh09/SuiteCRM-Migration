...
$hook_array['process_record'][] = Array(6, 'Change URL', 'custom/modules/Doc_DocsSolicitados/modifyUser.php','modifyUserClass', 'changeUrl');
$hook_array['process_record'][] = Array(5, 'Mostrar input', 'custom/modules/Doc_DocsSolicitados/modifyUser.php','modifyUserClass', 'commentInput');
