...
/*
$hook_array['process_record'][] = Array(1, 'addTotalOpportunities', 'custom/modules/Opportunities/SOELHooksRecibo.php','addTotalOpportunities', 'stepOne');
$hook_array['after_ui_frame'][] = Array(1, 'addTotalOpportunities', 'custom/modules/Opportunities/SOELHooksRecibo.php','addTotalOpportunities', 'stepTwo');
*/
...
$hook_array['before_save'][] = Array(79, 'Pre Save', 'custom/modules/Opportunities/SOELHooksRecibo.php','SOELHooksRecibo', 'pre_save');
...
$hook_array['after_save'][] = Array(79, 'Post Save', 'custom/modules/Opportunities/SOELHooksRecibo.php','SOELHooksRecibo', 'post_save');
...
$hook_array['before_delete'][] = Array(1, 'Colocar el coe, carta de oferta, servicio al cliente y visa como descartado cuando se elimine un proceso de venta', 'custom/modules/Opportunities/SOELHooksRecibo.php','SOELHooksRecibo', 'pre_delete');



$hook_array['before_save'][] = Array(1,'Create Note','custom/modules/Opportunities/SOELHooksListView.php','SOELHooksListView','create_note_pre');
$hook_array['after_save'][] = Array(1,'Create Note','custom/modules/Opportunities/SOELHooksListView.php','SOELHooksListView','create_note_post');
