...
array (
  ...
  array (
    'type' => 'varchar',
    'default' => true,
    'label' => 'LBL_DOCS_PORTAL_URL',
    'width' => '10%',
  ),
  'APPLICANT_REQUESTED_DOCS_C' => 
  array (
    'type' => 'int',
    'default' => true,
    'label' => 'LBL_APPLICANT_REQUESTED_DOCS',
    'width' => '10%',
  ),
  'APPLICANT_PENDING_DOCS_C' => 
  array (
    'type' => 'int',
    'default' => true,
    'label' => 'LBL_APPLICANT_PENDING_DOCS',
    'width' => '10%',
  ),
  'APPLICANT_UPLOADED_DOCS_C' => 
  array (
    'type' => 'int',
    'default' => true,
    'label' => 'LBL_APPLICANT_UPLOADED_DOCS',
    'width' => '10%',
  ),
  'APPLICANT_APPROVED_DOCS_C' => 
  array (
    'type' => 'int',
    'default' => true,
    'label' => 'LBL_APPLICANT_APPROVED_DOCS',
    'width' => '10%',
  ),
  'LEAD_SOURCE' => 
  array (
  ...
  'VIRTUAL_VISA_EXP_DATE_C' => 
  array (
    'type' => 'date',
    'default' => true,
    'label' => 'LBL_VIRTUAL_VISA_EXP_DATE',
    'width' => '10%',
  ),
  ...
  'VIRTUAL_SBS_APPROVAL_DATE_C' => 
  array (
    'type' => 'date',
    'default' => true,
    'label' => 'LBL_VIRTUAL_SBS_APPROVAL_DATE',
    'width' => '10%',
  ),
  'VIRTUAL_SBS_EXPECTATION_DATE_C' => 
  array (
    'type' => 'date',
    'default' => true,
    'label' => 'LBL_VIRTUAL_SBS_EXPECTATION_DATE',
    'width' => '10%',
  ),
  'VIRTUAL_TBS_APPROVAL_DATE_C' => 
  array (
    'type' => 'date',
    'default' => true,
    'label' => 'LBL_VIRTUAL_TBS_APPROVAL_DATE',
    'width' => '10%',
  ),
  'VIRTUAL_TBS_EXPECTATION_DATE_C' => 
  array (
    'type' => 'date',
    'default' => true,
    'label' => 'LBL_VIRTUAL_TBS_EXPECTATION_DATE',
    'width' => '10%',
  ),
  'VIRTUAL_TBS_APPLICATION_DATE_C' => 
  array (
    'type' => 'date',
    'default' => true,
    'label' => 'LBL_VIRTUAL_TBS_APPLICATION_DATE',
    'width' => '10%',
  ),
  'VIRTUAL_LABOUR_APPLICATION_DATE_C' => 
  array (
    'type' => 'date',
    'default' => true,
    'label' => 'LBL_VIRTUAL_LABOUR_APPLICATION_DATE',
    'width' => '10%',
  ),
  ...
  array (
    'type' => 'date',
    'default' => true,
    'label' => 'LBL_VIRTUAL_LABOUR_EXPECTATION_DATE',
    'width' => '10%',
  ),
  ...
  array (
    'type' => 'date',
    'default' => true,
    'label' => 'LBL_VIRTUAL_NOMINATION_APPROVAL_DATE',
    'width' => '10%',
  ),
  'NOMINATION_APP_DATE_VISA_C' => 
  array (
    'type' => 'date',
    'default' => true,
  ...
  'SKILL_ASSESSMENT_APP_DATE_VISA_C' => 
  array (
    'type' => 'date',
    'default' => true,
  ...
  array (
    ...
    'default' => false,
    'studio' => 'visible',
    'label' => 'LBL_LMT_PROCESS_STAGE',
    'width' => '10%',
  ),
  'NOMINATION_PROCESS_STAGE_C' => 
  array (
    'type' => 'multienum',
    'default' => false,
    'studio' => 'visible',
  ...
  'SKILL_ASSESSMENT_PROCESS_STAGE_C' => 
  array (
    'type' => 'multienum',
    'default' => false,
    'studio' => 'visible',
  ...
  'STATE_NOMINATION_PROCESS_STAGE_C' => 
  array (
    'type' => 'multienum',
    'default' => false,
    'studio' => 'visible',
  ...
  array (
    'type' => 'currency',
    'default' => false,
    'label' => 'LBL_THIRD_QUARTER_MMM_FEES_PAID_COMPANY',
    'currency_format' => true,
    'width' => '10%',
  ),
  ...
  array (
    'type' => 'currency',
    'default' => false,
    'label' => 'LBL_FIRST_QUARTER_MMM_FEES_PAID_APPLICANT',
    'currency_format' => true,
    'width' => '10%',
  ),
  ...
  array (
    'type' => 'currency',
    'default' => false,
    'label' => 'LBL_THIRD_QUARTER_MMM_FEES_PAID_APPLICANT',
    'currency_format' => true,
    'width' => '10%',
  ),
  ...
  array (
    'type' => 'currency',
    'default' => false,
    'label' => 'LBL_THIRD_QUARTER_MMM_FEES_PAID',
    'currency_format' => true,
    'width' => '10%',
  ),
  'NVC_COMPANIES_OPPORTUNITIES_1_NAME' => 
  array (
    'type' => 'relate',
    'link' => true,
    'label' => 'LBL_NVC_COMPANIES_OPPORTUNITIES_1_FROM_NVC_COMPANIES_TITLE',
    'id' => 'NVC_COMPANIES_OPPORTUNITIES_1NVC_COMPANIES_IDA',
    'width' => '10%',
    'default' => false,
  ),
  'RFI_NAME_5_C' => 
  ...
  array (
    ...
    'id' => 'VETA_RECIBO_OPPORTUNITIESVETA_RECIBO_IDA',
    'width' => '10%',
    'default' => false,
  ),
  'DATE_MODIFIED' => 
  ...
  'TOTAL_SKILL_ASSESSMENTE_APPLICANT_COMPANY_C' => 
  array (
    'type' => 'currency',
    'default' => false,
  ...
  'TOTAL_SKILL_ASSESSMENTE_APPLICANT_C' => 
  array (
    'type' => 'currency',
    'default' => false,
  ...
  'APPLICANT_COMPANY_DEPARTMENT_CREDIT_CARD_SURCHARGE_C' => 
  array (
    'type' => 'currency',
    'default' => false,
  ...
  'APPLICANT_COMPANY_DEPARTMENTS_VISA_FEE_C' => 
  array (
    'type' => 'currency',
    'default' => false,
  ...
  'COMPANY_DEPARTMENTS_VISA_FEE_C' => 
  array (
    'type' => 'currency',
    'default' => false,
  ...
  'APPLICANT_COMPANY_DEPARTMENT_VISA_FEE_BASE_APPLICATION_CHARGE_C' => 
  array (
    'type' => 'currency',
    'default' => false,
  ...
  'VISA_EXPIRE_2ST_DEPENDENT_DA_C' => 
  array (
    'type' => 'date',
    'default' => false,
  ...
  'VISA_EXPIRE_1ST_DEPENDENT_DA_C' => 
  array (
    'type' => 'date',
    'default' => false,
  ...
  'VISA_EXPIRE_SECONDARY_APPLIC_C' => 
  array (
    'type' => 'date',
    'default' => false,
    'label' => 'LBL_VISA_EXPIRE_SECONDARY_APPLIC',
    'width' => '10%',
  ),
  'COMPANY_REQUESTED_DOCS_C' => 
  array (
    'type' => 'varchar',
    'default' => false,
    'label' => 'LBL_COMPANY_REQUESTED_DOCS',
    'width' => '10%',
  ),
  'COMPANY_PENDING_DOCS_C' => 
  array (
    'type' => 'varchar',
    'default' => false,
    'label' => 'LBL_COMPANY_PENDING_DOCS',
    'width' => '10%',
  ),
  'COMPANY_APPROVED_DOCS_C' => 
  array (
    'type' => 'varchar',
    'default' => false,
    'label' => 'LBL_COMPANY_APPROVED_DOCS',
    'width' => '10%',
  ),
  'COMPANY_UPLOADED_DOCS_C' => 
  array (
    'type' => 'varchar',
    'default' => false,
    'label' => 'LBL_COMPANY_UPLOADED_DOCS',
    'width' => '10%',
  ),
);
;
