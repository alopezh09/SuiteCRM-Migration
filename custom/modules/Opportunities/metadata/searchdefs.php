  ...
  array (
    ...
    array (
      ...
      array (
        'type' => 'bool',
        'default' => true,
        'label' => 'LBL_PENDING_PAYMENTS',
        'width' => '10%',
        'name' => 'pending_payments_c',
      ),
      'second_quarter_c' => 
      array (
        'type' => 'bool',
        'default' => true,
        'label' => 'LBL_SECOND_QUARTER',
        'width' => '10%',
        'name' => 'second_quarter_c',
      ),
      'third_quarter_c' => 
      array (
        'type' => 'bool',
        'default' => true,
        'label' => 'LBL_THIRD_QUARTER',
        'width' => '10%',
        'name' => 'third_quarter_c',
      ),
      'filter_uploaded_docs_c' => 
      array (
        'type' => 'bool',
        'default' => true,
        'label' => 'LBL_FILTER_UPLOADED_DOCS',
        'width' => '10%',
        'name' => 'filter_uploaded_docs_c',
      ),
    ),
  ),
  'templateMeta' => 
