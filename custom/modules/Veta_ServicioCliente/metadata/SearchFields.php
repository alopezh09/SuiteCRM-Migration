...
$searchFields['Veta_ServicioCliente'] = array (
  'name' => 
  array (
    'query_type' => 'default',
  ),
  ...
  array (
    ...
    'subquery' => 'SELECT veta_serviciocliente.id AS ID FROM veta_serviciocliente 
                            ...
                            WHERE veta_serviciocliente.deleted = 0 AND veta_requerimiento.fecha_viaje >=  CONCAT(STR_TO_DATE(\'{0}\', \'%d-%m-%Y\') , \' 00:00:00\') AND veta_requerimiento.fecha_viaje <= CONCAT(STR_TO_DATE(\'{0}\', \'%d-%m-%Y\') , \' 23:59:59\')',
    'db_field' => 
    array (
      0 => 'id',
    ),
  ...
  array (
    ...
    'subquery' => 'SELECT veta_serviciocliente.id AS ID FROM veta_serviciocliente 
                            ...
                            INNER JOIN veta_requerimiento_veta_recibo_c ON veta_requerimiento_veta_recibo_c.veta_requerimiento_veta_reciboveta_recibo_idb = veta_recibo.id 
                            INNER JOIN veta_requerimiento ON veta_requerimiento.id = veta_requerimiento_veta_recibo_c.veta_requerimiento_veta_reciboveta_requerimiento_ida AND veta_requerimiento.deleted = 0 
                            WHERE veta_serviciocliente.deleted = 0 AND veta_requerimiento.fecha_viaje >=  CONCAT(STR_TO_DATE(\'{0}\', \'%d-%m-%Y\') , \' 00:00:00\')',
    'db_field' => 
    array (
      0 => 'id',
    ),
  ...
  array (
    ...
    'subquery' => 'SELECT veta_serviciocliente.id AS ID FROM veta_serviciocliente 
                            ...
                            INNER JOIN veta_requerimiento_veta_recibo_c ON veta_requerimiento_veta_recibo_c.veta_requerimiento_veta_reciboveta_recibo_idb = veta_recibo.id 
                            INNER JOIN veta_requerimiento ON veta_requerimiento.id = veta_requerimiento_veta_recibo_c.veta_requerimiento_veta_reciboveta_requerimiento_ida AND veta_requerimiento.deleted = 0 
                            WHERE veta_serviciocliente.deleted = 0 AND veta_requerimiento.fecha_viaje <= CONCAT(STR_TO_DATE(\'{0}\', \'%d-%m-%Y\') , \' 23:59:59\')',
    'db_field' => 
    array (
      0 => 'id',
    ),
  ...
  array (
    ...
    'subquery' => 'SELECT veta_serviciocliente.id AS ID FROM veta_serviciocliente 
                            ...
                            WHERE leads_cstm.fecha_expiracion_visa_c >=  CONCAT(STR_TO_DATE(\'{0}\', \'%d-%m-%Y\') , \' 00:00:00\') AND leads_cstm.fecha_expiracion_visa_c <= CONCAT(STR_TO_DATE(\'{0}\', \'%d-%m-%Y\') , \' 23:59:59\')
                            UNION 
                            ...
                            WHERE contacts_cstm.fecha_expiracion_visa_c >=  CONCAT(STR_TO_DATE(\'{0}\', \'%d-%m-%Y\') , \' 00:00:00\') AND contacts_cstm.fecha_expiracion_visa_c <= CONCAT(STR_TO_DATE(\'{0}\', \'%d-%m-%Y\') , \' 23:59:59\')',
    'db_field' => 
    array (
      0 => 'id',
    ),
  ...
  array (
    ...
    'subquery' => 'SELECT veta_serviciocliente.id AS ID FROM veta_serviciocliente 
                            ...
                            INNER JOIN leads ON leads.id = leads_opportunities_1_c.leads_opportunities_1leads_ida AND leads.deleted = 0 
                            INNER JOIN leads_cstm ON leads_cstm.id_c = leads.id 
                            WHERE leads_cstm.fecha_expiracion_visa_c >=  CONCAT(STR_TO_DATE(\'{0}\', \'%d-%m-%Y\') , \' 00:00:00\') 
                            UNION 
                            SELECT veta_serviciocliente.id AS ID FROM veta_serviciocliente 
                            INNER JOIN veta_serviciocliente_opportunities_c ON veta_serviciocliente_opportunities_c.veta_serviciocliente_opportunitiesveta_serviciocliente_idb = veta_serviciocliente.id AND veta_serviciocliente_opportunities_c.deleted = 0  
                            INNER JOIN opportunities ON opportunities.id = veta_serviciocliente_opportunities_c.veta_serviciocliente_opportunitiesopportunities_ida AND opportunities.deleted = 0 
                            ...
                            INNER JOIN contacts ON contacts.id = contacts_opportunities_1_c.contacts_opportunities_1contacts_ida AND contacts.deleted = 0 
                            INNER JOIN contacts_cstm ON contacts_cstm.id_c = contacts.id 
                            WHERE contacts_cstm.fecha_expiracion_visa_c >=  CONCAT(STR_TO_DATE(\'{0}\', \'%d-%m-%Y\') , \' 00:00:00\')',
    'db_field' => 
    array (
      0 => 'id',
    ),
  ...
  array (
    ...
    'subquery' => 'SELECT veta_serviciocliente.id AS ID FROM veta_serviciocliente 
                            ...
                            INNER JOIN leads ON leads.id = leads_opportunities_1_c.leads_opportunities_1leads_ida AND leads.deleted = 0 
                            INNER JOIN leads_cstm ON leads_cstm.id_c = leads.id 
                            WHERE leads_cstm.fecha_expiracion_visa_c <= CONCAT(STR_TO_DATE(\'{0}\', \'%d-%m-%Y\') , \' 23:59:59\')
                            UNION 
                            SELECT veta_serviciocliente.id AS ID FROM veta_serviciocliente 
                            INNER JOIN veta_serviciocliente_opportunities_c ON veta_serviciocliente_opportunities_c.veta_serviciocliente_opportunitiesveta_serviciocliente_idb = veta_serviciocliente.id AND veta_serviciocliente_opportunities_c.deleted = 0  
                            INNER JOIN opportunities ON opportunities.id = veta_serviciocliente_opportunities_c.veta_serviciocliente_opportunitiesopportunities_ida AND opportunities.deleted = 0 
                            ...
                            INNER JOIN contacts ON contacts.id = contacts_opportunities_1_c.contacts_opportunities_1contacts_ida AND contacts.deleted = 0 
                            INNER JOIN contacts_cstm ON contacts_cstm.id_c = contacts.id 
                            WHERE contacts_cstm.fecha_expiracion_visa_c <= CONCAT(STR_TO_DATE(\'{0}\', \'%d-%m-%Y\') , \' 23:59:59\')',
    'db_field' => 
    array (
      0 => 'id',
    ),
