...
$hook_array['process_record'][] = Array(1, 'addTotalLeads', 'custom/modules/Leads/SOELAuditoria.php','addTotalLeads', 'stepOne');
$hook_array['after_ui_frame'][] = Array(1, 'addTotalLeads', 'custom/modules/Leads/SOELAuditoria.php','addTotalLeads', 'stepTwo');
?>