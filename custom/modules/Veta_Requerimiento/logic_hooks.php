...
$hook_array['before_save'][] = Array(1,'Create Note','modules/Veta_Requerimiento/Veta_RequerimientoHooks.php','Veta_RequerimientoHooks','create_note_pre');
$hook_array['after_save'][] = Array(1,'Create Note','modules/Veta_Requerimiento/Veta_RequerimientoHooks.php','Veta_RequerimientoHooks','create_note_post');
