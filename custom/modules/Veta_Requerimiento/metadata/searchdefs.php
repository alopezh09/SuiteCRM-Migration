...
array (
  ...
  array (
    ...
    array (
      ...
      'nvc_companies_veta_requerimiento_1_name' => 
      array (
        'type' => 'relate',
        'link' => true,
        'label' => 'LBL_NVC_COMPANIES_VETA_REQUERIMIENTO_1_FROM_NVC_COMPANIES_TITLE',
        'id' => 'NVC_COMPANIES_VETA_REQUERIMIENTO_1NVC_COMPANIES_IDA',
        'width' => '10%',
        'default' => true,
