    ...
    array (
      ...
      array (
        ...
        array (
          ...
          4 => 
          array (
            'customCode' => '<input value="Download PDF" type="button" class="button" onClick="document.location=\'index.php?module=Veta_Recibo&action=pdf&rid=\'+ document.getElementsByName(\'record\')[0].value" >',
          ),
          5 => 
          array (
            'customCode' => '<input value="Download Company PDF" type="button" class="button" onClick="document.location=\'index.php?module=Veta_Recibo&action=pdf_company&pid=\'+ document.getElementsByName(\'record\')[0].value" >',
          ),
          6 => 
          array (
            'customCode' => '<input value="Send Invoice" type="button" class="button" onClick="document.location=\'index.php?module=Veta_Recibo&action=send&rid=\'+ document.getElementsByName(\'record\')[0].value" >',
          ),
        ),
      ),
      'maxColumns' => '2',
