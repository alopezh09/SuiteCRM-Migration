...
class PresupuestoPDF_company extends FPDF
{
    ...
    public function header() {
        ...
        $this->Cell( 0 , 3 , utf8_decode( "Budget Made on " . substr( $this->p->date_modified , 0 , 10 ) ) , 0 , 0 , 'R' );
        /*$this->Ln( 4 );
    ...
    private function print_curso( Veta_DetallePresupuesto $d ) {
        ...
        // ---------------------------------------------------- COMPONENT ----------------------------------------
         ...
         $this->Cell( 150 , 8 , utf8_decode( $x->components ) , 0 , 0 , 'L'  );
 
         // ---------------------------------------------------- CONCEPT ----------------------------------------
         $this->Ln( 5 );
         $this->Cell( 5 );
         $this->Cell( 100 , 3 , utf8_decode( 'Concept ' ) , 0 , 0 , 'L' );
         $this->Cell( 150 , 8 , utf8_decode( $x->concept ) , 0 , 0 , 'L'  );
 
         // ---------------------------------------------------- FEE ----------------------------------------
 
         $this->Ln( 5 );
         $this->Cell( 5 );
         $this->Cell( 100 , 3 , utf8_decode( 'Fee ' ) , 0 , 0 , 'L' );
         $this->Cell( 0 , 3 , utf8_decode(  number_format( ( $x->fee * 1 ) , 2 , ',' , '.' ) ) . ' AUD' , 0 , 0 , 'R' );
    ...
    private function print_details() {
        ...
        $this->Cell( 100 , 6 , utf8_decode( "DEPOSIT " ) , 0 , 0 , 'L' , true );
        $this->SetFont( 'Arial' , 'B' , 10 );
        ...
        $this->Cell( 100 , 6 , utf8_decode( "TOTAL FIRST PAYMEN " ) , 0 , 0 , 'L' , true );
        $this->SetFont( 'Arial' , 'B' , 10 );
