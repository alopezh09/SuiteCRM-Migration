...
class SugarWidgetSubPanelTopSelectButtonCustomTemplates extends SugarWidgetSubPanelTopButton
{
    ...
    public function display($widget_data, $additionalFormFields = null, $nonbutton = false)
    {
		...
		if ($widget_data['focus']->module_name == 'Veta_Requerimiento') {			
			$initial_filter = '&document_module_c_advanced=Requirements';
		} /*
			else {	
				$initial_filter = '&document_module_c_advanced=Workflow'; 
		}
		*/
