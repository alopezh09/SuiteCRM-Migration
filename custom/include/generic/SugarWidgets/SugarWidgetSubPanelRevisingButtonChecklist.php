...
class SugarWidgetSubPanelRevisingButtonChecklist extends SugarWidgetField
{
	...
	*/
	...
	public function displayList(&$layout_def)
    {
		...
		$html ="<a id='revising_$record_id'>Revising</a>";
		$html .= "
		<script>
				$('#revising_$record_id').click(function(event) {
						event.preventDefault();   
						$.get('/revising_document_status.php',{id:'$record_id',module:'$module_name'},function(responseText) { 
							location.reload() 
					});
				});
		</script>";
