...
$table_insert   = "veta_requerimiento";
...
$result = mysqli_query($connection,"SELECT * FROM vetacrm2.".$table." where date_modified >= ".$date_filter." and 
...
/*(assigned_user_id = '31a00644-9229-cd6c-ef57-5ec88dc89e89')
or (assigned_user_id = 'e4c4db80-a351-5dc8-a23a-5a996977e583')
or   (assigned_user_id = 'd13f0b61-ce0c-04f4-442a-5ecf16984a92')
or (assigned_user_id = 'db15ecb6-86b9-acb1-7d60-5be91404a21b')
or (assigned_user_id = 'e9b75e91-66e9-a637-18fc-5e0fc51d443e')
or (assigned_user_id = '5f450e05-96f2-145c-2ffa-5b86b0cbfc55')
or (assigned_user_id = 'a8df0791-fef6-e844-793a-5c58b04eaae6')
or (assigned_user_id = '2c228535-4ea2-3e12-e67b-5be884f4bd99')
or (assigned_user_id = '688ab293-f4f0-6804-22ca-5be8ce451e66')
or (assigned_user_id = '2344d1ea-4210-8fee-897e-5a999e993db2')
or (assigned_user_id = '3411a746-e972-52dd-c8fa-6046af5e3987')
or (assigned_user_id = '7baaaec8-67e7-e6e5-87b6-61382d5e68dc')
or (assigned_user_id = '10f08f8e-c818-ff81-848e-5eeadc36571b')
*/
