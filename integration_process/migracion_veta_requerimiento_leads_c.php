...
$table_insert   = "veta_requerimiento_leads_c";
...
$result = mysqli_query($connection,"SELECT * FROM vetacrm2.".$table." 
where veta_requerimiento_leadsveta_requerimiento_idb in ( 
(
SELECT id FROM vetacrm2.veta_requerimiento where 
/* date_modified >= ".$date_filter." and */ 
